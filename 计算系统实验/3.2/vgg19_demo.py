...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        # pool1
        input_shapep1 = pycnnl.IntVector(4)
        input_shapep1[0] = 1
        input_shapep1[1] = 64
        input_shapep1[2] = 224
        input_shapep1[3] = 224
        self.net.createPoolingLayer('pool1', input_shapep1, 2, 2)
        ...
        # pool2
        input_shapep2 = pycnnl.IntVector(4)
        input_shapep2[0] = 1
        input_shapep2[1] = 128
        input_shapep2[2] = 112
        input_shapep2[3] = 112
        self.net.createPoolingLayer('pool2', input_shapep2, 2, 2)
        ...
        # pool3
        input_shapep3 = pycnnl.IntVector(4)
        input_shapep3[0] = 1
        input_shapep3[1] = 256
        input_shapep3[2] = 56
        input_shapep3[3] = 56
        self.net.createPoolingLayer('pool3', input_shapep3, 2, 2)
        ...
        # pool4
        input_shapep4 = pycnnl.IntVector(4)
        input_shapep4[0] = 1
        input_shapep4[1] = 512
        input_shapep4[2] = 28
        input_shapep4[3] = 28
        self.net.createPoolingLayer('pool4', input_shapep4, 2, 2)
        ...
        # pool5
        input_shapep5 = pycnnl.IntVector(4)
        input_shapep5[0] = 1
        input_shapep5[1] = 512
        input_shapep5[2] = 14
        input_shapep5[3] = 14
        self.net.createPoolingLayer('pool5', input_shapep5, 2, 2)
        # fc6
        ...
        self.net.createSoftmaxLayer('softmax',input_shapes ,2)
