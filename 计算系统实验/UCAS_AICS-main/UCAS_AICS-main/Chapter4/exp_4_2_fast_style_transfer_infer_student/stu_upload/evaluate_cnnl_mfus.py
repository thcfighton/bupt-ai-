...
if __name__ == '__main__':
    ...
    for i, image in enumerate(data_group):
        ...
        image_g_mlu = F.interpolate(image_g_mlu, size=image_c.shape[2:])
        combined_image = torch.cat((image_c, image_g_mlu), dim=2)
        save_image(combined_image, './out/mlu_cnnl_mfus/%d.jpg' % i)
