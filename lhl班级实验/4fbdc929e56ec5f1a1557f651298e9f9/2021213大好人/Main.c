...
-----------------------------  ProducerConsumer  ---------------------------------
  ...
  function Producer (myId: int)
      ...
      for i = 1 to 5
        ...
        sEmpty.Down () -- wait,buffer is full.
        MLock.Lock () -- handling multi producer multi consumer
  ...
  function Consumer (myId: int)
      ...
      while true
        ...
        sFull.Down () -- wait,buffer is empty
        MLock.Lock () -- handling multi producer multi consumer
...
-----------------------------  Dining Philosophers  ---------------------------------
  ...
  behavior ForkMonitor
    ...
    method Init ()
      ...
      -- Initialize CV(conditional variable)
      cond = new Condition
      cond.Init ()
